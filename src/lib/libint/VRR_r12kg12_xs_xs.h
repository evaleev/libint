...
namespace libint2 {
  ...
  template <int part, FunctionPosition where, int La, int Lc, int K, bool vectorize> struct VRR_r12kg12_xs_xs {
  ...
  /** builds (a 0| G_K |c0), where G_K = r12^K * G12, for K >= 0. For K == -1 use OSVRR (just make sure prefactors are modified accordingly).
      src0 = (a-10|G_K|c0)
      src1 = (a-20|G_K|c0)
      src2 = (a-10|G_K|c-10)
      src3 = (a0|G_K-2|c0)
      ...
      src5 = (a-10|G_K-2|c0)
   **/
  template <int La, int Lc, int K, bool vectorize> struct VRR_r12kg12_xs_xs<0,InBra,La,Lc,K,vectorize> {
