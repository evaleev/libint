...
constexpr unsigned int am1 = 0;
constexpr unsigned int am2 = 0;
constexpr unsigned int am3 = 0;
...
//  LIBINT2_PREFIXED_NAME(libint2_init_eri0)(&erieval[0],max_am,0);
  ...
  auto prep_data = [=](Libint_t* ev) {
    ...
    for(auto pt=0; pt!=npts; ++pt, ++ev) {
      ...
      ev->_00_GTG1d_00_x[0] = ev->_00_GTG1d_00_y[0] = ev->_00_GTG1d_00_z[0] = M_PI * sqrt(oogammap * oogammaq);
