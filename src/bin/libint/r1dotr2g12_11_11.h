  ...
  */
  template <class BFS> class R1dotR2G12_11_11 :
    ...
    public:
      ...
      */
      static const SafePtr<R1dotR2G12_11_11> Instance(const BFS& bra0, const BFS& ket0, const BFS& bra1, const BFS& ket1, unsigned int m);
      /// Returns a pointer to a unique instance, a la Singleton
...
#  error "USE_INT_KEY_TO_HASH must be set"
  ...
  template <class BFS>
    const SafePtr< R1dotR2G12_11_11<BFS> >
    R1dotR2G12_11_11<BFS>::Instance(const BFS& bra0, const BFS& ket0, const BFS& bra1, const BFS& ket1, unsigned int m)
    {
#if USE_BRAKET_H
      typedef BFS BFSRef;
