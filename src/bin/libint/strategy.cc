...
template <>
struct MasterStrategy<Coulombσp_11_11_sq> {
  typedef boost::mpl::list<CR_11_Coulombσp_11_sh> value;
};
template <>
struct MasterStrategy<Coulombσp_11_11_int> {
  typedef boost::mpl::list<CR_11_Coulombσp_11_int> value;
};
