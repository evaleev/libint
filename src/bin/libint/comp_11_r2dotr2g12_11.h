...
namespace libint2 {
  ...
  */
  ...
  template <template <class> class I, class F>
    std::shared_ptr< CR_11_R2dotR2G12_11<I,F> >
    CR_11_R2dotR2G12_11<I,F>::Instance(const std::shared_ptr<TargetType>& Tint)
    {
  ...
  template <template <class> class I, class F>
    CR_11_R2dotR2G12_11<I,F>::CR_11_R2dotR2G12_11(const std::shared_ptr<I<F> >& Tint) :
