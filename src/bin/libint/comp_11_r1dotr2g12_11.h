...
namespace libint2 {
  ...
  */
  ...
  template <template <typename,typename,typename> class I, class F>
    std::shared_ptr< CR_11_R1dotR2G12_11<I,F> >
    CR_11_R1dotR2G12_11<I,F>::Instance(const std::shared_ptr<TargetType>& Tint)
    {
  ...
  template <template <typename,typename,typename> class I, class F>
    CR_11_R1dotR2G12_11<I,F>::CR_11_R1dotR2G12_11(const std::shared_ptr<TargetType>& Tint) :
