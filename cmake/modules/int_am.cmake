...
if (LIBINT_MAX_AM GREATER_EQUAL 8)
    message(WARNING "LIBINT_MAX_AM=${LIBINT_MAX_AM} is greater than 8. Are you sure you know what you are doing?")
        ...
        if (_ntokens GREATER 1)
            ...
            if (WITH_${class}_MAX_AM EQUAL -1)
                ...
                if (${class}_MAX_AM GREATER_EQUAL 8)
                    message(WARNING "Value for ${class}_MAX_AM too high (${${class}_MAX_AM} >= 8). Are you sure you know what you are doing?")
